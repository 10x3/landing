...
export const standards = [
  "Typed everywhere - no `any`, no loose schemas",
  "CI green before merge, no exceptions",
  "Test coverage held at team target - new code held higher",
  "Security linting + dependency auditing on every PR",
  "Small, reversible migrations only",
  "Observability wired on day one, not month six",
];
